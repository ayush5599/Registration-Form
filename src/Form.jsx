...
const Form1 = () => {
    ...
    const handaleFName = (event) => {
        console.log(event);  // return event object
        console.log(event.target);  // return html element where that event is occurr
        setfName(event.target.value)  // value attribute of that html element 
    }


    const [LName, setLName] = useState('')
    const handaleLName = (event) => {
        console.log(event);  // return event object
        console.log(event.target);  // return html element where that event is occurr
        setLName(event.target.value)  // value attribute of that html element 
    }
    ...
    return (
        <div>
            ...
            <label id="errMatch">Password and Confirm Password not matching</label>
            <br /><br />
            <input
                type="date"
                id="inpDob"
                ...
                onChange={handleDob}
            />
            <label id="errDob">Date of Birth is required</label>
            <br /><br />
            <input
                type="text"
                placeholder="city"
